...
const { authMock, getWorkspaceForUserMock, ensureWorkspaceForUserMock } = vi.hoisted(
  () => ({
    authMock: vi.fn(),
    getWorkspaceForUserMock: vi.fn(),
...
beforeEach(() => {
  ...
  getWorkspaceForUserMock.mockResolvedValue({ id: "ws_1", name: "Creator" });
