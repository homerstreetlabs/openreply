import { declaredStatement, unwrapTypeParentheses } from "../shared/ast.js";
...
export const noUnknownTypeAliases = {
	meta: {
		type: "problem",
		docs: {
			description:
	...
	create(context) {
		...
		const resolvesToUnknown = (type, visited = new Set()) => {
			if (unwrapTypeParentheses(type).type === "TSUnknownKeyword") return true;
